...
METHOD2 = 'PMC'
model = "CBV1"
PATH_MODEL1 = 'Result/sector/{}/{}/'.format(METHOD1,model)
PATH_MODEL2 = 'Result/sector/{}/{}/'.format(METHOD2,model)
...
a = testing.MCIS(nsenario, nSim1, PATH_MODEL1,CONTRI = True)
...
with open(PATH_MODEL1 + "contri_data.json", 'r') as load_f:
